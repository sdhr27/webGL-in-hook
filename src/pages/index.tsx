...
var options: any = [
  ...
  { label: '立方体旋转', value: '11', component: <CubeSpin /> },
  { label: '多立方体', value: '12', component: <MulCube /> },
...
function App() {
  ...
  function renderGL() {
    return (
      options.find(item => item.value === target)?.component || (
        <div>openGL渲染错误</div>
      )
    );
  }
